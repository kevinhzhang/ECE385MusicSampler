	lab7_soc u0 (
		...
		.i2cserial_sda_in               (<connected-to-i2cserial_sda_in>),               //               i2cserial.sda_in
		.i2cserial_scl_in               (<connected-to-i2cserial_scl_in>),               //                        .scl_in
		.i2cserial_sda_oe               (<connected-to-i2cserial_sda_oe>),               //                        .sda_oe
		.i2cserial_scl_oe               (<connected-to-i2cserial_scl_oe>)                //                        .scl_oe
	);
